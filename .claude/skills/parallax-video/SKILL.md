...
2.  Record               → screen recordings/V<N>/vidN.mp4 (user does this in OS)
...
7.  Iterate              → re-run 5 + 5.5 + 6 freely
8.  Approve preview      → user confirms layout/timing/copy shippable
